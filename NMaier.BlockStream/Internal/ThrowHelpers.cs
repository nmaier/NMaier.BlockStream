...
internal static class ThrowHelpers
{
  ...
  [DoesNotReturn]
  [MethodImpl(MethodImplOptions.NoInlining)]
  internal static void ThrowArgumentOutOfRangeException(string name, object value, string msg)
  {
  ...
  {
    throw new IOException("Cannot write new compress-able block larger than on disk block");
  }
